...
public class Polymoph {
    public static void main(String[] args) {
        ...
        // 자식클래스의 타입이 부모클래스의 타입으로 바뀌는것을 '업캐스팅'이라 하고
        ...
        // 여전히, draw매서드 호출시 동일한 클래스타입을 사용해야 함
