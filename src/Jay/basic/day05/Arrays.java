...
public class Arrays {
	...
	public static void main(String[] args) {
		...
		uid = new String[3];  
				// 3명분의 아이디를 저장할 수 있는배열변수 선언
				// new : 참조형객체를 생성하라는 의미의 연산자
				// 기본 자료형 객체는 변수가 실제 값이 저장됨
		...
		// 임의의 숫자 : 난수 random
		// Random  클래스를 이용하면 원하는형태의 난수 생성 가능
		int[] lotto = new int[6];
