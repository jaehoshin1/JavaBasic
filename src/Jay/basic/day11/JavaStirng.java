package Jay.basic.day11;

import java.util.Date;

public class JavaStirng {
    public static void main(String[] args) {
        ...
        // chatAt, concatindexOf, trim, length
        //toLowerCase, toUpperCase, split, substring


        // 자바에서 String 객체는 메모리 재활용interning
        // 즉, 생성된 String 객체값은 String Pool에 저장한데,
        ...
        if (jumin.charAt(7) == '1') System.out.println("남자입니다");
        ...
        // format : c언어의 prinf처럼 서식문자열을 이용해서
        //          변수와 특정 문자열을 조합해서 문자열을 생성하는 메서드
        // 반면, System.out.printf메서드는 생성된 문자열을
        // 화면에 출력하는데 사용하는 메서드임
        Date today = new Date();
