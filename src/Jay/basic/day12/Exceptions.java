...
public class Exceptions {
    public static void main(String[] args) throws IOException {
        ...
        // 이처럼 프로그램 실행중에 예상치 못한 상활으로
        // 프로그램의 실행에 영향을 주는 것을
        // 예외와 오류로 구분할 수 있음

        // 오류는 시스템 단계에서 심각한 문제를야기해서
        // 실행중인 프로그램을 강제로 종료시킴
...
//
        ...
        // 명시적인 예외처리를 반드시 강제함 (!!)
        // 예외발생 시점은 컴파일할때 complie time임
        // IOException
        // ClassNotFoundException

        // ex ) 임의의 성적데이터(이름,구어,영어,수학)를
        ...
        // 예외처리 회피/양도/떠넘기기
        // 메서드 선언부에 throw를 사용해서
        // 해당 메서드에서 발생한 예외를 미리 명시하고
        // 메서드를 호출한 상위메서드에서
        // 이것을 처리할 수 있도록 함
        // 이를 통해서 각 하위 메서들에서 발생하는 예외들을
        // 한 곳에서 모아서 처리할 수 있음
