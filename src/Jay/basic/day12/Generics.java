...
//        Integer.parseInt(numbers2[2]));
        ...
        // => Objet타입은 바로 정수로 변환 불가라서

        // JDK1.5이전에서는 여러 타입을 사용하는 대부분의 클래스나
        // 매서드에서 인수나 반환값으로 Object타입을 사용했었음
        ...
        // nums2라는 배열변수에는 String타입의 값만 저장할 수 있음
