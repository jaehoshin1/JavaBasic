...
//        s.prof = "504";
        ...
        Person p2 = new Person("김미남", "교수",
                 47, "남","AB");
        //
//        Student s = new Student(hakbun:"201350050", name:"김태희", addr:"경기도 고양시",birth:"1985.3.22", dname: "컴퓨터",prof:"504");
//        Student s1 = new Student(hakbun:"201250006", name:"송혜교", addr:"서울영등포구",birth:"1988.9.17", dname: "컴퓨터",prof:"301");
        Student s2 = new Student("201252110","전지현","경기도의정부시","1986.4.30",  "의상디자인","445");
//        Student s3 = new Student(hakbun:"201351010", name:"수  지", addr:"서울 성북구",birth:"1988.7.13", dname: "식품영양",prof:"556");
//       Student s4 = new Student(hakbun:"201353011", name:"아이유", addr:"경기도천안시",birth:"198 7.2.25", dname: "철학",prof:"504");
    ...
    //고객 클래스
    static class Person {
        //변수선언 (속성property,필드firld, 멤버member)
        private String name;
        private String job;
        private int age;
